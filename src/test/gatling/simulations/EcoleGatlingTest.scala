...
/**
 * Performance test for the Ecole entity.
 */
class EcoleGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Ecole entity")
        ...
        .repeat(2) {
            ...
            .pause(10)
            .repeat(5) {
                exec(http("Get created ecole")
                .get("${new_ecole_url}")
                .headers(headers_http_authenticated))
                .pause(10)
            }
            .exec(http("Delete created ecole")
            .delete("${new_ecole_url}")
            .headers(headers_http_authenticated))
            .pause(10)
        }
